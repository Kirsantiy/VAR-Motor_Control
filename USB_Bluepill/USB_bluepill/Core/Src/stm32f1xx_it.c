...
extern volatile PIDCONTROLLER P_angle;
extern volatile PIDCONTROLLER PI_velocity;

extern volatile uint16_t countvar;
uint16_t counter = 0;
extern volatile uint16_t counter_tx;
...
/* USER CODE BEGIN EV */
extern volatile int16_t receive;
/* USER CODE END EV */
